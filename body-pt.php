        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav roboto">
                    ...
                    <a class="nav-item nav-link" href="<?php echo $root; ?>assets/doc/Curriculum_Vitae_Rafael_Machado.pdf" target="_blank">Currículo</a>
                    ...
                    <li id="drop" class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            <?php if (isset($_SESSION['user'])) { ?>
                                <a class="dropdown-item" href="system.php">Início</a>
                                <a class="dropdown-item" href="horarios/">Horários</a>
