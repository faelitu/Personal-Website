...
<body id="all">
    ...
    if (isset($valid) && $valid) { 
        require_once "horarios/table-functions.php"; ?>
        <!--CORPO DA PÁGINA-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav roboto">
                        ...
                        <a class="nav-item nav-link" href="horarios/">Horários</a>
        ...
        <div class="container text-center bloco" id="now">
            <div><?=date("l")?></div>
            <div><?=date("d/m/Y")." - ".date("H:i")?></div>
            <br/>
            <div id="running"><?=getNow()?></div>
        </div>
